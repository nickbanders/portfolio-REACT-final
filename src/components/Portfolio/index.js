      ...
      <ul id="cards">
          ...
          <div class="card__content">
            <div>
              ...
              <p>
                ...
                it has been future-proofed with technologies such as responsive
                design, React, MongoDB, and GraphQL. It has features such as a
                full course page with hole selector tool, user login/logout
                authentication containing Admin-level privileges such as site
                price customization, and queries and mutations for full CRUD
                capabilities.
                <br />
                <br />
                As the frontend lead for this project my job was taking the
                design and implementing it into React.js. As well as creating
                all necessary components needed for a seamless user experience.
                A major focus was the responsive nature of the website so it
                performed and looked great no matter what screen you're viewing
        ...
        <li class="card" id="card_2">
          <div class="card__content">
            <div>
              ...
              <p>
                An app that generates a one stop shop for both weather and surf
                forecast. The app will make use of StormGlass' free API and the
                Weather API. Users will first enter a zipcode, a forecast for
                that day's weather and maritime stats will populate.
                <br />
                <br />
          ...
          <div class="card__content">
            <div>
              ...
              <p>
                ...
                course of 6-months was the lack of time for personal projects. I
                wanted to dive further into React.js since it was something that
                I enjoyed working with during the Rio Colorado project, and
                decided to focus on that for a website of my own. <br />
                <br />I utlized libraries such as framer-motion to create an
                animation for the SVG logo I created, As well as Animate.css on
                certain elements to make some letters feel alive. I also used
          ...
          <div class="card__content">
            <div>
              ...
              <p>
                ...
                their dashboard of posts they've made, and also view and comment
                on others.
                <br />
                <br />
        ...
        <li className="card" id="card_5">
          <div className="card__content2">
            ...
            <h4>
              Here are some links that will take you to videos showing examples
              of my work on the server side
            </h4>
            <div className="backend_container">
              <div className="backend_column">
                <h4>Team Profile Generator</h4>
                <p className="backend_paragraph">
                  The challenge was to build a Node.js command-line application
                  that takes in information about employees on a software
                  engineering team and generates an HTML webpage that displays
                  summaries for each person. <br />
                  <br />
              ...
              <div className="backend_column backend_column_border">
                <h4>e-commerce</h4>
                <p className="backend_paragraph">
                  E-commerce platforms like Shopify provide a suite of services
                  to businesses of all sizes. Due to the prevalence of these
                  platforms, developers should understand the fundamental
                  architecture of e-commerce sites.
                  <br />
                  <br />I took a working Express.js API and configured it to use
