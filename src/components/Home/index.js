        ...
        <div className="text-zone">
          <h1>
            <span className="animated-intro">
              ...
              />
              <br />
              <span class="hidden">Web Developer.</span>
              <AnimatedLetters
                letterClass={letterClass}
                strArray={jobArray}
                idx={27}
          ...
          <div className="hide-btn">
            <Link to="/contact" className="flat-button-home">
              CONTACT ME
            </Link>
          </div>
        </div>
